...
theme_show() {
    ...
    text+="^bg($colBlack)^fg($colBlue400)$deco_da_l"
		text+="^bg($colBlue400) $segmentHost "
    text+="^bg($colBlack)^fg($colBlue400)$deco_da_r"
		text+="^bg($colBlack) $segmentDate "
    text+="^bg($colBlack)^fg($colBlue600)$deco_da_l"
		text+="^bg($colBlue600) $segmentUptime "
    text+="^bg($colBlack)^fg($colBlue600)$deco_da_r"
		text+="^bg($colBlack) $segmentBattery "
    text+="^bg($colBlack)^fg($colBlue400)$deco_da_l"
		# text+="^bg($colBlack) $segmentUpdates "
  # text+=" $segmentMPD "
    text+=" "
